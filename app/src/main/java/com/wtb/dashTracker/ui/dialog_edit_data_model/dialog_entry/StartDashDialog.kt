...
import com.wtb.dashTracker.util.registerMultiplePermissionsLauncher
import com.wtb.dashTracker.util.registerSinglePermissionLauncher
import com.wtb.dashTracker.util.showRationaleBgLocation
...
class StartDashDialog : EditDataModelDialog<DashEntry, DialogFragStartDashBinding>() {
    ...
    private val locationPermLauncher =
        registerMultiplePermissionsLauncher(::getBgLocationPermission)
    private val bgLocationPermLauncher = registerSinglePermissionLauncher(::loadNewTrip)
    ...
    private val locationServiceConnection = object : ServiceConnection {
        override fun onServiceConnected(name: ComponentName?, service: IBinder?) {
            ...
            locationService?.initialize(
                locationServiceNotifData,
                getNotificationChannel(),
                { "Mileage tracking is on. Background location is in use." }
            )
